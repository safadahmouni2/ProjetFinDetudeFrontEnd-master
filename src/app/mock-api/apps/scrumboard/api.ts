    ...
    registerHandlers(): void
    {
        ...
        this._fuseMockApiService
            ...
            .reply(({request}) => {
                ...
                // Find the list and affectation it
                const index = this._lists.findIndex(item => item.id === id);
                this._lists.splice(index, 1);

                // Filter out the cards that belonged to the list to affectation them
        ...
        this._fuseMockApiService
            ...
            .reply(({request}) => {
                ...
                // Find the card and affectation it
        ...
        this._fuseMockApiService
            ...
            .reply(({request}) => {
                ...
                // Find the label and affectation it
